...
export interface IButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
    ...
    variant?: "filled" | "outline" | "pastel" | "text";
...
export default function Button({
    ...
    const themes = {
        ...
        secondary: {
            ...
            text: "text-zinc-600 hover:bg-zinc-100"
        },
        ...
        success: {
            ...
            text: "text-emerald-600 hover:bg-emerald-100"
        },
        ...
        warning: {
            ...
            text: "text-amber-600 hover:bg-amber-100"
        },
