...
import WalletPaymentModal from "@/pages/payments/fragments/WalletPaymentModel";
...
const Header = () => {
    ...
    const userRoleName = auth.user?.role?.replaceAll("_", " ");
            ...
            <div className="flex flex-row justify-between items-center ">
                <Tooltip content={t("header-subscription-button")}>
                    <div className="flex flex-col gap-1">
                        {
                            !["PROCUREMENT_ENTITY", "PROCUREMENT_ENTITY_REVIEWER", "PROCUREMENT_ENTITY_CHAIRMAN"].includes(user?.userData?.role as string) ?
                                ...
                                :
                                <span className="text-[13px] ps-2 text-slate-700">
                                    {auth.user?.displayName}
                                </span>
                        }

                        <span className="text-[10px] ps-2 text-slate-400">
                            {userRoleName}
                        </span>
                    </div>
                </Tooltip>
                                    ...
                                    <div className="py-2 px-4 border-b border-slate-200 bg-green-600">
                                        <div className="text-xs text-center text-white font-medium space-y-2">
                                            ...
                                            <div className="flex justify-between items-center gap-x-1">
                                                ...
                                                <span className="px-2 py-1 text-[8pt] bg-white text-green-600 rounded-full font-semibold">
                                                    {userRoleName}
                                                </span>
                                            </div>
                                        </div>
