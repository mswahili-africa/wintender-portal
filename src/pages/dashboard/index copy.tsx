...
export default function Dashboard() {
    ...
    const AdminStats = () => (
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <StatCard icon={IconGitPullRequest} title="Do it for me" description={`Requests: ${summary?.requests}`} to="/do-it-for-me" />
            ...
            <StatCard icon={IconUsersGroup} title="Bidders" description={`Active: ${summary?.bidders}`} to="/bidders" />
            <StatCard icon={IconBuilding} title="Government entities" description={`Government: ${summary?.procurementEntities?.GOVERNMENT ?? 0}  `} to="/do-it-for-me" />
            <StatCard icon={IconBuildingStore} title="Private entities" description={` Private: ${summary?.procurementEntities?.PRIVATE ?? 0} `} to="/do-it-for-me" />
    ...
    const PEStats = () => (
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <StatCard icon={IconGitPullRequest} title="Tender Box" description={`Applications: ${summary?.applications}`} to="/tender-box" />
        </div>
    );
    ...
    const BidderStats = () => (
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
            <StatCard icon={IconUser} title={account} description="Account" to={`/users/${userId}`} />
            <StatCard icon={IconFileText} title="Tenders" description={`Open: ${summary?.tenders}`} to="/tenders" />
