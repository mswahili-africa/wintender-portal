...
export default function SubscriptionPlanFormModal({ open, onClose, onSuccess, initials }: IProps) {
    ...
    return (
        ...
        <Modal size="sm" title="Create Subscription Plan" isOpen={open} onClose={onClose}>
